...
Defaults to the CI-calibration backtest and 2023 Q2, the window the original
hand-built file covered. Keeping the same window means a regeneration changes
the numbers because the MODEL changed, not because the window moved -- do not
widen it casually, or an apparent improvement may just be quarter-picking.
"""
